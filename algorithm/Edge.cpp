...
//기본 그레디언트 구하기
void Edge::get_gradient(const Mat &img, Mat &dy, Mat &dx) {
...
int Edge::quantize_direction(int val) {
	int direction;
...
void Edge::thresholding(Mat &out, const Mat &mag, const double T_high, const double T_low) {
